...
.app-header.business-only {
  justify-content: flex-start;
  gap: 0;
}

.app-header.business-only .header-left {
  flex: 0 0 auto;
}

.app-header.business-only .header-right {
  display: none;
}
...
`;
  ...
  const businessOnly = config.businessOnly === true;
  const showLocation = config.showLocation !== false && !businessOnly;
  const showNotifications = config.showNotifications !== false && !businessOnly;
  const showPartnerMenu = config.showPartnerMenu !== false && !businessOnly;
  const headerClass = businessOnly ? "app-header business-only" : "app-header";
  const locationMarkup = showLocation ? `
  ...
  ` : "";
  const notifDropdownMarkup = showNotifications ? `
